...
var ServiceProvider = /** @class */ (function (_super) {
    ...
    */
    ServiceProvider.prototype.createLoginRequest = function (idp, binding, relayState, customTagReplacement) {
        ...
        if (protocol === nsBinding.redirect) {
            return binding_redirect_1.default.loginRequestRedirectURL({ idp: idp, sp: this, relayState: relayState }, customTagReplacement);
        }
        if (protocol === nsBinding.post) {
            ...
            return __assign(__assign({}, context), { relayState: relayState !== null && relayState !== void 0 ? relayState : this.entitySetting.relayState, entityEndpoint: idp.entityMeta.getSingleSignOnService(binding), type: 'SAMLRequest' });
        }
