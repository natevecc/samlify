...
export declare class ServiceProvider extends Entity {
    ...
    */
    createLoginRequest(idp: IdentityProvider, binding?: 'redirect' | 'post', relayState?: string, customTagReplacement?: (template: string) => BindingContext): BindingContext | PostBindingContext;
    /**
